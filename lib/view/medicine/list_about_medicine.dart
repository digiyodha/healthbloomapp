...
class ListAboutMedicine extends StatefulWidget {
  ...
  ListAboutMedicine({Key key, this.id}) : super(key: key);

  @override
  State<ListAboutMedicine> createState() => _ListAboutMedicineState();
}

class _ListAboutMedicineState extends State<ListAboutMedicine> {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Center(
                                      child: TextBuilder(
                                        text: snapshot.data.data.medicineName ??
                                            '',
                                        fontSize: 18,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextBuilder(
                                fontSize: 14,
                                text: 'Total Tablets : ' +
                                    snapshot.data.data.totalTablets.toString(),
                                color: Color(0xff5D5D5D),
                                fontWeight: FontWeight.w500,
                              ),
                              const SizedBox(height: 10.0),
                              ...
                              TextBuilder(
                                fontSize: 14,
                                text: 'Duration Left : ' +
                                    snapshot.data.data.durationLeft.toString(),
                                color: Color(0xff5D5D5D),
                                fontWeight: FontWeight.w500,
                              ),
                            ],
