...
class AddBillResponseData {
  ...
  factory AddBillResponseData.fromJson(Map<String, dynamic> json) =>
      AddBillResponseData(
        billImage: json["bill_image"] == null
            ? null
            : List<ImageListRequest>.from(
                json["bill_image"].map((x) => ImageListRequest.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        "bill_image": billImage == null
            ? null
            : List<dynamic>.from(billImage.map((x) => x.toJson())),
...
class GetAllDocumentsResponseBill {
  ...
  factory GetAllDocumentsResponseBill.fromJson(Map<String, dynamic> json) =>
      GetAllDocumentsResponseBill(
        ...
        reportImage: json["report_image"] == null
            ? null
            : List<ImageListRequest>.from(
                json["report_image"].map((x) => ImageListRequest.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "report_image": reportImage == null
            ? null
            : List<dynamic>.from(reportImage.map((x) => x.toJson())),
      };
}
...
class GetAllDocumentsResponsePrescription {
  ...
  factory GetAllDocumentsResponsePrescription.fromJson(
      ...
      GetAllDocumentsResponsePrescription(
        ...
        prescriptionImage: json["prescription_image"] == null
            ? null
            : List<ImageListRequest>.from(json["prescription_image"]
                .map((x) => ImageListRequest.fromJson(x))),
        patient: json["patient"] == null
            ? null
            : GetAllDocumentsResponsePatient.fromJson(json["patient"]),
        userId: json["user_id"] == null ? null : json["user_id"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "prescription_image": prescriptionImage == null
            ? null
            : List<dynamic>.from(prescriptionImage.map((x) => x.toJson())),
        "patient": patient == null ? null : patient.toJson(),
        "user_id": userId == null ? null : userId,
      };
}
...
class MapsNearbyMedicalsResponse {
  ...
  factory MapsNearbyMedicalsResponse.fromJson(Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponse(
        success: json["success"] == null ? null : json["success"],
        data: json["data"] == null
            ? null
            : MapsNearbyMedicalsResponseData.fromJson(json["data"]),
      );
...
class MapsNearbyMedicalsResponseData {
  ...
  factory MapsNearbyMedicalsResponseData.fromJson(Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponseData(
        ...
        results: json["results"] == null
            ? []
            : List<MapsNearbyMedicalsResponseResult>.from(json["results"]
                .map((x) => MapsNearbyMedicalsResponseResult.fromJson(x))),
...
class MapsNearbyMedicalsResponseResult {
  ...
  factory MapsNearbyMedicalsResponseResult.fromJson(
          Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponseResult(
        businessStatus:
        ...
        geometry: json["geometry"] == null
            ? null
            : MapsNearbyMedicalsResponseGeometry.fromJson(json["geometry"]),
        ...
        openingHours: json["opening_hours"] == null
            ? null
            : MapsNearbyMedicalsResponseOpeningHours.fromJson(
                json["opening_hours"]),
        photos: json["photos"] == null
            ? []
            : List<MapsNearbyMedicalsResponsePhoto>.from(json["photos"]
                .map((x) => MapsNearbyMedicalsResponsePhoto.fromJson(x))),
        placeId: json["place_id"] == null ? null : json["place_id"],
        plusCode: json["plus_code"] == null
            ? null
            : MapsNearbyMedicalsResponsePlusCode.fromJson(json["plus_code"]),
...
class MapsNearbyMedicalsResponseGeometry {
  ...
  factory MapsNearbyMedicalsResponseGeometry.fromJson(
          Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponseGeometry(
        location: json["location"] == null
            ? null
            : MapsNearbyMedicalsResponseLocation.fromJson(json["location"]),
        viewport: json["viewport"] == null
            ? null
            : MapsNearbyMedicalsResponseViewport.fromJson(json["viewport"]),
      );
...
class MapsNearbyMedicalsResponseLocation {
  ...
  factory MapsNearbyMedicalsResponseLocation.fromJson(
          Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponseLocation(
...
class MapsNearbyMedicalsResponseViewport {
  ...
  factory MapsNearbyMedicalsResponseViewport.fromJson(
          Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponseViewport(
        northeast: json["northeast"] == null
            ? null
            : MapsNearbyMedicalsResponseLocation.fromJson(json["northeast"]),
        southwest: json["southwest"] == null
            ? null
            : MapsNearbyMedicalsResponseLocation.fromJson(json["southwest"]),
      );
...
class MapsNearbyMedicalsResponseOpeningHours {
  ...
  factory MapsNearbyMedicalsResponseOpeningHours.fromJson(
          Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponseOpeningHours(
...
class MapsNearbyMedicalsResponsePhoto {
  ...
  factory MapsNearbyMedicalsResponsePhoto.fromJson(Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponsePhoto(
...
class MapsNearbyMedicalsResponsePlusCode {
  ...
  factory MapsNearbyMedicalsResponsePlusCode.fromJson(
          Map<String, dynamic> json) =>
      MapsNearbyMedicalsResponsePlusCode(
        compoundCode:
...
class MapsPlaceDetailsResponse {
  ...
  factory MapsPlaceDetailsResponse.fromJson(Map<String, dynamic> json) =>
      MapsPlaceDetailsResponse(
        success: json["success"] == null ? null : json["success"],
        data: json["data"] == null
            ? null
            : MapsPlaceDetailsResponseData.fromJson(json["data"]),
      );
...
class MapsPlaceDetailsResponseData {
  ...
  factory MapsPlaceDetailsResponseData.fromJson(Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseData(
        htmlAttributions: json["html_attributions"] == null
            ? []
            : List<dynamic>.from(json["html_attributions"].map((x) => x)),
        result: json["result"] == null
            ? null
            : MapsPlaceDetailsResponseResult.fromJson(json["result"]),
        status: json["status"] == null ? null : json["status"],
      );
...
class MapsPlaceDetailsResponseResult {
  ...
  factory MapsPlaceDetailsResponseResult.fromJson(Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseResult(
        addressComponents: json["address_components"] == null
            ? []
            : List<MapsPlaceDetailsResponseAddressComponent>.from(
                json["address_components"].map((x) =>
                    MapsPlaceDetailsResponseAddressComponent.fromJson(x))),
        ...
        geometry: json["geometry"] == null
            ? null
            : MapsPlaceDetailsResponseGeometry.fromJson(json["geometry"]),
        icon: json["icon"] == null ? null : json["icon"],
        iconBackgroundColor: json["icon_background_color"] == null
            ? null
            : json["icon_background_color"],
        ...
        openingHours: json["opening_hours"] == null
            ? null
            : MapsPlaceDetailsResponseOpeningHours.fromJson(
                json["opening_hours"]),
        photos: json["photos"] == null
            ? []
            : List<MapsPlaceDetailsResponsePhoto>.from(json["photos"]
                .map((x) => MapsPlaceDetailsResponsePhoto.fromJson(x))),
        placeId: json["place_id"] == null ? null : json["place_id"],
        plusCode: json["plus_code"] == null
            ? null
            : MapsPlaceDetailsResponsePlusCode.fromJson(json["plus_code"]),
        rating: json["rating"] == null ? null : json["rating"].toDouble(),
        reference: json["reference"] == null ? null : json["reference"],
        reviews: json["reviews"] == null
            ? []
            : List<MapsPlaceDetailsResponseReview>.from(json["reviews"]
                .map((x) => MapsPlaceDetailsResponseReview.fromJson(x))),
        types: json["types"] == null
            ? []
            : List<String>.from(json["types"].map((x) => x)),
...
class MapsPlaceDetailsResponseAddressComponent {
  ...
  factory MapsPlaceDetailsResponseAddressComponent.fromJson(
          Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseAddressComponent(
...
class MapsPlaceDetailsResponseGeometry {
  ...
  factory MapsPlaceDetailsResponseGeometry.fromJson(
          Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseGeometry(
        location: json["location"] == null
            ? null
            : MapsPlaceDetailsResponseLocation.fromJson(json["location"]),
        viewport: json["viewport"] == null
            ? null
            : MapsPlaceDetailsResponseViewport.fromJson(json["viewport"]),
      );
...
class MapsPlaceDetailsResponseLocation {
  ...
  factory MapsPlaceDetailsResponseLocation.fromJson(
          Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseLocation(
        lat: json["lat"] == null ? null : json["lat"].toDouble(),
        lng: json["lng"] == null ? null : json["lng"].toDouble(),
...
class MapsPlaceDetailsResponseViewport {
  ...
  factory MapsPlaceDetailsResponseViewport.fromJson(
          Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseViewport(
        northeast: json["northeast"] == null
            ? null
            : MapsPlaceDetailsResponseLocation.fromJson(json["northeast"]),
        southwest: json["southwest"] == null
            ? null
            : MapsPlaceDetailsResponseLocation.fromJson(json["southwest"]),
      );
...
class MapsPlaceDetailsResponseOpeningHours {
  ...
  factory MapsPlaceDetailsResponseOpeningHours.fromJson(
          Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseOpeningHours(
        openNow: json["open_now"] == null ? null : json["open_now"],
        periods: json["periods"] == null
            ? []
            : List<MapsPlaceDetailsResponsePeriod>.from(json["periods"]
                .map((x) => MapsPlaceDetailsResponsePeriod.fromJson(x))),
...
class MapsPlaceDetailsResponsePeriod {
  ...
  factory MapsPlaceDetailsResponsePeriod.fromJson(Map<String, dynamic> json) =>
      MapsPlaceDetailsResponsePeriod(
        close: json["close"] == null
            ? null
            : MapsPlaceDetailsResponseClose.fromJson(json["close"]),
        open: json["open"] == null
            ? null
            : MapsPlaceDetailsResponseClose.fromJson(json["open"]),
      );
...
class MapsPlaceDetailsResponseClose {
  ...
  factory MapsPlaceDetailsResponseClose.fromJson(Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseClose(
...
class MapsPlaceDetailsResponsePhoto {
  ...
  factory MapsPlaceDetailsResponsePhoto.fromJson(Map<String, dynamic> json) =>
      MapsPlaceDetailsResponsePhoto(
        height: json["height"] == null ? null : json["height"],
        htmlAttributions: json["html_attributions"] == null
            ? []
...
class MapsPlaceDetailsResponsePlusCode {
  ...
  factory MapsPlaceDetailsResponsePlusCode.fromJson(
          Map<String, dynamic> json) =>
      MapsPlaceDetailsResponsePlusCode(
        compoundCode:
            json["compound_code"] == null ? null : json["compound_code"],
...
class MapsPlaceDetailsResponseReview {
  ...
  factory MapsPlaceDetailsResponseReview.fromJson(Map<String, dynamic> json) =>
      MapsPlaceDetailsResponseReview(
...
class AddEditReminderResponse {
  ...
  factory AddEditReminderResponse.fromJson(Map<String, dynamic> json) =>
      AddEditReminderResponse(
        success: json["success"] == null ? null : json["success"],
        data: json["data"] == null
            ? null
            : AddEditReminderResponseData.fromJson(json["data"]),
      );
...
class AddEditReminderResponseData {
  ...
  factory AddEditReminderResponseData.fromJson(Map<String, dynamic> json) =>
      AddEditReminderResponseData(
        reminderType:
            json["reminder_type"] == null ? null : json["reminder_type"],
        family: json["family"] == null ? null : json["family"],
        dateTime: json["date_time"] == null
            ? null
            : DateTime.parse(json["date_time"]).toLocal(),
        description: json["description"] == null ? null : json["description"],
        userId: json["user_id"] == null ? null : json["user_id"],
...
class GetReminderResponse {
  ...
  factory GetReminderResponse.fromJson(Map<String, dynamic> json) =>
      GetReminderResponse(
        ...
        data: json["data"] == null
            ? null
            : GetReminderResponseData.fromJson(json["data"]),
      );
...
class GetReminderResponseData {
  ...
  factory GetReminderResponseData.fromJson(Map<String, dynamic> json) =>
      GetReminderResponseData(
        id: json["_id"] == null ? null : json["_id"],
        reminderType:
            json["reminder_type"] == null ? null : json["reminder_type"],
        familyObject: json["familyObject"] == null
            ? null
            : GetReminderResponseFamilyObject.fromJson(json["familyObject"]),
        description: json["description"] == null ? null : json["description"],
        dateTime: json["date_time"] == null
            ? null
            : DateTime.parse(json["date_time"]).toLocal(),
...
class GetReminderResponseFamilyObject {
  ...
  factory GetReminderResponseFamilyObject.fromJson(Map<String, dynamic> json) =>
      GetReminderResponseFamilyObject(
        name: json["name"] == null ? null : json["name"],
        relationship:
            json["relationship"] == null ? null : json["relationship"],
...
class GetReminderListResponse {
  ...
  factory GetReminderListResponse.fromJson(Map<String, dynamic> json) =>
      GetReminderListResponse(
        ...
        data: json["data"] == null
            ? null
            : List<GetReminderListResponseDatum>.from(json["data"]
                .map((x) => GetReminderListResponseDatum.fromJson(x))),
      );
...
class GetReminderListResponseFamilyObject {
  ...
  factory GetReminderListResponseFamilyObject.fromJson(
          Map<String, dynamic> json) =>
      GetReminderListResponseFamilyObject(
        name: json["name"] == null ? null : json["name"],
        relationship:
...
class GetDocumentsFamilyResponse {
  ...
  factory GetDocumentsFamilyResponse.fromJson(Map<String, dynamic> json) =>
      GetDocumentsFamilyResponse(
        success: json["success"] == null ? null : json["success"],
        data: json["data"] == null
            ? null
            : GetDocumentsFamilyResponseData.fromJson(json["data"]),
      );
...
class GetDocumentsFamilyResponseData {
  ...
  factory GetDocumentsFamilyResponseData.fromJson(Map<String, dynamic> json) =>
      GetDocumentsFamilyResponseData(
        bill: json["bill"] == null
            ? []
            : List<GetDocumentsFamilyResponseBill>.from(json["bill"]
                .map((x) => GetDocumentsFamilyResponseBill.fromJson(x))),
        report: json["report"] == null
            ? []
            : List<GetDocumentsFamilyResponseBill>.from(json["report"]
                .map((x) => GetDocumentsFamilyResponseBill.fromJson(x))),
        prescription: json["prescription"] == null
            ? []
            : List<GetDocumentsFamilyResponsePrescription>.from(
                json["prescription"].map(
                    (x) => GetDocumentsFamilyResponsePrescription.fromJson(x))),
      );
...
class GetDocumentsFamilyResponseBill {
  ...
  factory GetDocumentsFamilyResponseBill.fromJson(Map<String, dynamic> json) =>
      GetDocumentsFamilyResponseBill(
        id: json["_id"] == null ? null : json["_id"],
        name: json["name"] == null ? null : json["name"],
        amount: json["amount"] == null ? null : json["amount"],
        ...
        patient: json["patient"] == null
            ? null
            : GetDocumentsFamilyResponsePatient.fromJson(json["patient"]),
        userId: json["user_id"] == null ? null : json["user_id"],
        reportImage: json["report_image"] == null
            ? null
            : List<ImageListRequest>.from(
...
class GetDocumentsFamilyResponsePatient {
  ...
  factory GetDocumentsFamilyResponsePatient.fromJson(
          Map<String, dynamic> json) =>
      GetDocumentsFamilyResponsePatient(
        name: json["name"] == null ? null : json["name"],
        relationship:
...
class GetDocumentsFamilyResponsePrescription {
  ...
  factory GetDocumentsFamilyResponsePrescription.fromJson(
          Map<String, dynamic> json) =>
      GetDocumentsFamilyResponsePrescription(
        id: json["_id"] == null ? null : json["_id"],
        doctorName: json["doctor_name"] == null ? null : json["doctor_name"],
...
class GetHealthScoreResponse {
  ...
  factory GetHealthScoreResponse.fromJson(Map<String, dynamic> json) =>
      GetHealthScoreResponse(
        success: json["success"] == null ? null : json["success"],
        data: json["data"] == null
            ? null
            : GetHealthScoreResponseData.fromJson(json["data"]),
      );
...
class GetHealthScoreResponseData {
  ...
  factory GetHealthScoreResponseData.fromJson(Map<String, dynamic> json) =>
      GetHealthScoreResponseData(
...
class WaterCheckResponse {
  ...
  factory WaterCheckResponse.fromJson(Map<String, dynamic> json) =>
      WaterCheckResponse(
        success: json["success"] == null ? null : json["success"],
        data: json["data"] == null
            ? null
            : WaterCheckResponseData.fromJson(json["data"]),
      );
...
class WaterCheckResponseData {
  ...
  factory WaterCheckResponseData.fromJson(Map<String, dynamic> json) =>
      WaterCheckResponseData(
        targetAmount:
            json["target_amount"] == null ? null : json["target_amount"],
        dailyWaterConsumed: json["daily_water_consumed"] == null
            ? null
            : json["daily_water_consumed"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "daily_water_consumed":
            dailyWaterConsumed == null ? null : dailyWaterConsumed,
        "date": date == null ? null : date.toIso8601String(),
        "user_id": userId == null ? null : userId,
        "createdAt": createdAt == null ? null : createdAt.toIso8601String(),
        "updatedAt": updatedAt == null ? null : updatedAt.toIso8601String(),
...
class MedicineCheckUncheckResponse {
  ...
  factory MedicineCheckUncheckResponse.fromJson(Map<String, dynamic> json) =>
      MedicineCheckUncheckResponse(
        success: json["success"] == null ? null : json["success"],
        data: json["data"] == null
            ? null
            : MedicineCheckUncheckResponseData.fromJson(json["data"]),
      );
...
class MedicineCheckUncheckResponseData {
  ...
  factory MedicineCheckUncheckResponseData.fromJson(
          Map<String, dynamic> json) =>
      MedicineCheckUncheckResponseData(
        check: json["check"] == null ? null : json["check"],
        medicineTime: json["medicine_time"] == null
            ? null
            : DateTime.parse(json["medicine_time"]),
        userId: json["user_id"] == null ? null : json["user_id"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "medicine_time":
            medicineTime == null ? null : medicineTime.toIso8601String(),
        "user_id": userId == null ? null : userId,
